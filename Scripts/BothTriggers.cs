...
public class BothTriggers : MonoBehaviour
{
    ...
    public string effectname1 = "snow2";
    public string effectname2 = "snow3";
    ...
    void Update()
    {
        ...
        if (effectTrigger2 && effect1.name == "flower")
        {
            ...
            {
                Debug.Log("Effect not enabled");
            }
            
        }
        else if (!effectTrigger2 && effect1.name == "flower")
        {
